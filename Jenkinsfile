            ...
            steps {
                sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
    			  ...
    			  unzip ${WORKSPACE}/dev/ant_build/artifacts/codewind*.zip -d ${WORKSPACE}/dev/ant_build/artifacts/repository
                  	  ...
                  	  ssh genie.codewind@projects-storage.eclipse.org rm -rf /home/data/httpd/download.eclipse.org/codewind/codewind-openapi-eclipse/$GIT_BRANCH/latest
                  	  ssh genie.codewind@projects-storage.eclipse.org mkdir -p /home/data/httpd/download.eclipse.org/codewind/codewind-openapi-eclipse/$GIT_BRANCH/latest
                  	  scp -r ${WORKSPACE}/dev/ant_build/artifacts/* genie.codewind@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/codewind/codewind-openapi-eclipse/$GIT_BRANCH/latest
		      else
