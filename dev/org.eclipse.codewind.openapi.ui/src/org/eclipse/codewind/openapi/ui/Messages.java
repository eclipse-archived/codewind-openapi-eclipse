...
public class Messages extends NLS {
	...
	public static String BROWSE_DIALOG_OUTPUT_FOLDER_INVALID;
	public static String BROWSE_DIALOG_OUTPUT_FOLDER_INVALID_MESSAGE;
	
	public static String JOB_GENERATING;
	public static String JOB_UPDATING_MAVEN_PROJECT;
	public static String JOB_UPDATING_CLASSPATH;
	
	public static String MAVEN_PROJECT_DETECTED_TITLE;
	public static String MAVEN_PROJECT_DETECTED_DESCRIPTION;
	public static String MAVEN_PROJECT_DIFFERENT_OUTPUT_FOLDER_DESCRIPTION;
