 ...
 *******************************************************************************/
package org.eclipse.codewind.openapi.test.client;
...
public abstract class AbstractClientGenerateTest extends AbstractGenerateTest {

	public AbstractClientGenerateTest(String name) {
		super(name);
	}

	@Override
	protected AbstractOpenApiGeneratorCommand getCommand() {
		return new GenerateClientCommand();
	}
}
