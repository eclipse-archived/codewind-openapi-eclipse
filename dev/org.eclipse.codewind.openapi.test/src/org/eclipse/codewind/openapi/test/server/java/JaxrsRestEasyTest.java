...
public class JaxrsRestEasyTest extends AbstractServerGenerateTest {

	public JaxrsRestEasyTest() {
		super("jaxrs-resteasy");
		newProjectName = "JaxrsRestEasyProject";
		targetOutputFolder = "/JaxrsRestEasyProject";
		language = "Java";
		generatorType = "jaxrs-resteasy";
		sourceDefinition = Constants.PETSTORE_30;
		targetDefinitionInProject = "petstore.yaml";
	}

	@Test
    public void testJaxrsRestEasyGenerator() {
    	super.doTest();
    }
